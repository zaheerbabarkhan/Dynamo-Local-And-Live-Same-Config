...
// src/functions/conditionalUpdate/handler.ts
__export(exports, {
  main: () => main
});
...
// src/libs/dynamo.config.ts
var AWS = __toModule(require("aws-sdk"));
var dynamo = process.env.IS_OFFLINE ? new AWS.DynamoDB.DocumentClient({
  region: "localhost",
  endpoint: "http://localhost:8000"
}) : new AWS.DynamoDB.DocumentClient();

// src/functions/conditionalUpdate/handler.ts
var conditionalUpdate = async (event) => {
  try {
    const query = {
...
var main = middyfy(conditionalUpdate);
